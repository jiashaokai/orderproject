...
public class RedisServiceImp implements RedisService {
     ...
     */
    @Override
    public boolean lSetStr(String key, String value) {
        try {
            redisTemplate.opsForList().rightPush(key, value);
            return true;
        } catch (Exception e) {
     ...
     */
    @Override
    public boolean rSetStr(String key, Object value) {
        try {
     ...
     */
    @Override
    public long lRemoveStr(String key, long count, String value) {
        try {
            Long remove = redisTemplate.opsForList().remove(key, count, value);
            return remove;
        } catch (Exception e) {
    ...
    @Override
    public boolean ltSetTime(String key, Object value, long time) {
        try {
            redisTemplate.opsForList().leftPush(key, value);
            if (time > 0) {
                expire(key, time);
